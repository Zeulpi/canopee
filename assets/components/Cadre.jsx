  ...
  return (
    <>
      <div className='text-canBlue about-container w-100'>
        ...
        <div className="about row mx-auto justify-content-center">
          <div className={`about-left col-12 col-md-6 p-2 d-flex justify-content-center ${props.image2 ? "row" : null}`}>
